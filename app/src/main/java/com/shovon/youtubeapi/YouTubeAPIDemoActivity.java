...
import com.shovon.youtubeapi.adapter.DemoArrayAdapter;
import com.shovon.youtubeapi.adapter.DemoListViewItem;
...
public class YouTubeAPIDemoActivity extends Activity implements OnItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TextView disabledText = findViewById(R.id.some_demos_disabled_text);
